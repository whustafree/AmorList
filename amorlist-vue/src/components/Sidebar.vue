<template>
  <aside class="w-64 bg-black/40 backdrop-blur-md border-r border-white/10 flex flex-col p-4 h-full">
    ...
    <div class="mt-auto text-center text-xs text-gray-500 opacity-50 pb-4">
